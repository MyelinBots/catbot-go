//go:generate mockgen -destination=mocks/mock_player_repository.go -package=mocks github.com/MyelinBots/catbot-go/internal/db/repositories/player PlayerRepository
package player
